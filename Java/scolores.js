...
function draw() {
  ...
  gradient.addColorStop(0, 'rgba(242,75,75,1)');    // (rojo)
  gradient.addColorStop(1, 'rgba(166,125,50,1)');   // (marrón/dorado)
...
class Particle {
  ...
  class ParticleSystem {
    ...
    connectParticles(particleA, particleB) {
      let opacity = particleA.framesRemaining / particleFadeFrames;
      stroke(217, 180, 230, opacity * 255); // #D9B4E6 transparency
      line(
        particleA.position.x,
        particleA.position.y,
        particleB.position.x,
